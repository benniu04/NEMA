...
const WatchlistPage: React.FC = () => {
  ...
  const handleRemoveFromWatchlist = async (movieId: string, movieTitle: string, e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
  ...
  const watchlist = (user.watchlist?.filter((movie: any) => movie && typeof movie === 'object' && movie._id) || []) as Movie[];
